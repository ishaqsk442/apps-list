...
class AppStore extends Component {
  ...
  filtereSearchedApps = () => {
    ...
    const filteredApps = appsList.filter(each =>
  ...
  filterTabResults = filteredApps => {
    const {activeTab} = this.state
    const tabResults = filteredApps.filter(
  ...
  render() {
    ...
    const filteredApps = this.filtereSearchedApps()

    const tabResults = this.filterTabResults(filteredApps)
